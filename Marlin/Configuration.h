...
#define STRING_CONFIG_H_AUTHOR "(RoBo3D, R1 Single Extruder)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2267.72,723.38}  // default steps per unit for Ultimaker
